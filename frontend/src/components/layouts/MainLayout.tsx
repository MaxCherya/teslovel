...
export default function MainLayout() {
    ...
    return (
        <div className='relative max-w-screen w-screen min-h-screen h-screen overflow-x-hidden'>
            ...
            {/* Mobile Nav */}
            <MobileNav setShowBikes={setShowBikes} showBikes={showBikes} toggleLanguageMenu={toggleLanguageMenu} setShowLanguageMenu={setShowLanguageMenu} toggleMenu={toggleMenu} showMenu={showMenu} />
