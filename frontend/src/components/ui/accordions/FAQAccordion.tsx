...
const FAQAccordion: React.FC = () => {
    ...
    const faq = [
        ...
        },
        {
            ...
            answer:
                "Ми єдині у місті з такою послугою, забезпечуємо повну підтримку, доставку, обслуговування, індивідуальний підхід і унікальні батареї з великим запасом ходу."
        },
        {
